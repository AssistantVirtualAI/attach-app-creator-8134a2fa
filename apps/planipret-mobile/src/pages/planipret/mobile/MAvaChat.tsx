...
export default function MAvaChat() {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden" style={{ background: "var(--pp-bg-base)", marginTop: "-3cm", paddingTop: "3cm", paddingBottom: 130, contain: "layout paint size" }}>
      <div className="sticky top-0 z-10 flex items-center gap-2 px-3 py-1 backdrop-blur-xl" style={{ transform: "translateY(-3cm)", marginBottom: "-3cm", background: "color-mix(in srgb, var(--pp-bg-surface) 78%, transparent)", borderBottom: "1px solid var(--pp-bg-border)" }}>

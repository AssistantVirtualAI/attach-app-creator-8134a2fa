...
export const AVA_TOOL_LABELS = {
  ...
  list_my_clients: { fr: "Liste de vos clients Maestro", en: "Listing your Maestro clients" },
  get_maestro_client_profile: { fr: "Profil client Maestro", en: "Maestro client profile" },
  list_my_brokers: { fr: "Liste de vos courtiers Maestro", en: "Listing your Maestro brokers" },
  get_maestro_broker_profile: { fr: "Profil courtier Maestro", en: "Maestro broker profile" },

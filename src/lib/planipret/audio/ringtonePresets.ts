...
export const RINGTONE_PRESETS: RingtonePreset[] = [
  ...
  {
    id: "aurora",
    label: { fr: "Aurora (moderne)", en: "Aurora (modern)" },
    steps: [
      { freqs: [880, 1318], ms: 140, type: "sine" },
      { freqs: [], ms: 60 },
      { freqs: [1046, 1567], ms: 140, type: "sine" },
      { freqs: [], ms: 60 },
      { freqs: [1318, 1975], ms: 320, type: "sine" },
    ],
    gapMs: 1100,
    volume: 0.13,
  },
  {
    id: "signal",
    label: { fr: "Signal", en: "Signal" },
    steps: [
      { freqs: [1046], ms: 90, type: "triangle" },
      { freqs: [], ms: 60 },
      { freqs: [1046], ms: 90, type: "triangle" },
      { freqs: [], ms: 60 },
      { freqs: [1396], ms: 260, type: "triangle" },
    ],
    gapMs: 1200,
    volume: 0.12,
  },
  {
    ...
    steps: [
      { freqs: [1567], ms: 110, type: "sine" },
      { freqs: [1318], ms: 110, type: "sine" },
      { freqs: [1046], ms: 110, type: "sine" },
      { freqs: [1318], ms: 110, type: "sine" },
      { freqs: [1567], ms: 380, type: "sine" },
    ],
    gapMs: 1300,
    volume: 0.12,
  },
  {
    id: "beacon",
    label: { fr: "Balise", en: "Beacon" },
    steps: [
      { freqs: [523, 784], ms: 220, type: "triangle" },
      { freqs: [], ms: 100 },
      { freqs: [587, 880], ms: 220, type: "triangle" },
      { freqs: [], ms: 100 },
      { freqs: [659, 988], ms: 420, type: "triangle" },
    ],
    gapMs: 1500,
    volume: 0.14,
  },
  {
    id: "uplift",
    label: { fr: "Ascension", en: "Uplift" },
    steps: [
      { freqs: [659], ms: 120, type: "sine" },
      { freqs: [784], ms: 120, type: "sine" },
      { freqs: [988], ms: 120, type: "sine" },
      { freqs: [1174], ms: 120, type: "sine" },
      { freqs: [1318], ms: 360, type: "sine" },
    ],
    gapMs: 1000,
    volume: 0.13,
  },
  {
    ...
    label: { fr: "Zen", en: "Zen" },
    steps: [
      { freqs: [432, 648], ms: 700, type: "sine" },
      { freqs: [], ms: 200 },
      { freqs: [576, 864], ms: 900, type: "sine" },
    ],
    gapMs: 2200,
    volume: 0.13,
  },
  {
    ...
    label: { fr: "Pop", en: "Pop" },
    steps: [
      { freqs: [1318], ms: 70, type: "square" },
      { freqs: [], ms: 50 },
      { freqs: [1567], ms: 70, type: "square" },
      { freqs: [], ms: 50 },
      { freqs: [2093], ms: 130, type: "square" },
    ],
    gapMs: 900,
    volume: 0.09,
  },
  {
    id: "corporate",
    label: { fr: "Corporatif", en: "Corporate" },
    steps: [
      { freqs: [523, 659, 784], ms: 420, type: "sine" },
      { freqs: [], ms: 160 },
      { freqs: [587, 740, 880], ms: 620, type: "sine" },
    ],
    gapMs: 1800,
    volume: 0.13,
  },
  {
    ...
    steps: [
      { freqs: [988, 1318], ms: 100, type: "sawtooth" },
      { freqs: [], ms: 70 },
      { freqs: [988, 1318], ms: 100, type: "sawtooth" },
      { freqs: [], ms: 70 },
      { freqs: [988, 1318], ms: 100, type: "sawtooth" },
      { freqs: [], ms: 70 },
      { freqs: [1174, 1567], ms: 240, type: "sawtooth" },
    ],
    gapMs: 900,
    volume: 0.1,
  },

        ...
        <div className="absolute bottom-0 inset-x-0 h-[52px] flex flex-col items-center justify-center z-10 pp-mobile-footer" style={{ gap: 2 }}>
          <div className="flex items-center gap-2.5">
            ...
            <div className="relative flex items-center justify-center" style={{ width: 40, height: 40 }}>
              ...
              <div className="absolute inset-0 rounded-full" style={{ background: "conic-gradient(from 0deg, #7C3AED, #2E9BDC, #00D4AA, #7C3AED)", padding: 2, animation: "ava-footer-spin 6s linear infinite" }}>
                <div className="w-full h-full rounded-full flex items-center justify-center overflow-hidden" style={{ background: "var(--pp-bg-surface, #0A1628)" }}>
                  <img src={avaLogoAsset.url} alt="AVA Statistics" style={{ height: 28, width: 28, objectFit: "contain", borderRadius: 6 }} />
                </div>
              </div>
            </div>

    ...
    <Frame>
      ...
      <div className="h-full flex flex-col relative overflow-hidden" style={{ background: "var(--pp-bg-base)" }}>
        ...
        <div className="absolute bottom-0 inset-x-0 h-[34px] flex items-center justify-center gap-2 z-10 pp-mobile-footer">
          ...
          <img src={avaLogoAsset.url} alt="AVA Statistics" style={{ height: 26, width: 26, objectFit: "contain", borderRadius: 6, filter: "drop-shadow(0 2px 8px rgba(124,58,237,0.45))" }} />

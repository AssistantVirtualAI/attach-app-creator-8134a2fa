...
const NAV: Array<{ sectionKey: SectionKey; items: Array<{ to: string; key: NavKey; Icon: any; badge?: NavBadge }> }> = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/planipret/admin/maestro-brokers", key: "maestroBrokers", Icon: Users },
      ...
      { to: "/planipret/admin/broker-journey", key: "brokerJourney", Icon: UserSquare2 },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/planipret/admin/telephony-dashboard", key: "telephonyDashboard", Icon: Gauge },
      { to: "/planipret/admin/outbound-audio",  key: "outboundAudio",   Icon: Mic },
      { to: "/planipret/admin/transcript-tracking", key: "transcriptTracking", Icon: Mic },
      { to: "/planipret/admin/client-calls", key: "clientCalls", Icon: Users },
      { to: "/planipret/admin/broker-telephony", key: "brokerTelephony", Icon: Phone },
      { to: "/planipret/admin/broker-monthly", key: "brokerMonthly", Icon: Gauge },
...
const PAGE_KEY_BY_PATH: Record<string, PageKey> = {
  ...
  "/planipret/admin/telephony-dashboard": "telephonyDashboard",
  "/planipret/admin/outbound-audio": "outboundAudio",
  "/planipret/admin/transcript-tracking": "transcriptTracking",
  "/planipret/admin/client-calls": "clientCalls",
  "/planipret/admin/broker-telephony": "brokerTelephony",
  "/planipret/admin/broker-monthly": "brokerMonthly",
  ...
  "/planipret/admin/maestro-brokers": "maestroBrokers",
  ...
  "/planipret/admin/broker-journey": "brokerJourney",

...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const requestedScope = "openid profile email offline_access User.Read Mail.ReadWrite Mail.Send Calendars.ReadWrite Chat.ReadWrite ChannelMessage.Send Team.ReadBasic.All Channel.ReadBasic.All";

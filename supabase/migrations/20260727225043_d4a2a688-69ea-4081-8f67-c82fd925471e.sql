REVOKE ALL ON public.planipret_profiles FROM authenticated;
...
GRANT UPDATE (
  full_name, phone, avatar_url, language, metadata,
  ...
  notif_hot_leads, notif_appointment_reminder, notif_missed_call,
  notif_morning_brief, notif_eod_summary, onboarding_completed, onboarding_step,
  voicemail_greeting_text, voicemail_greeting_voice_id, voicemail_greeting_active,
  ava_preferred_lang, ava_autonomy_mode, ava_voice_id, ava_voice_stability,
  ava_voice_similarity, ava_voice_style, ava_voice_speed, ava_chat_mode,
  updated_at
) ON public.planipret_profiles TO authenticated;
